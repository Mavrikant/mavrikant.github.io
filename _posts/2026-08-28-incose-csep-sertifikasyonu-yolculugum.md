...
Sistem mühendisliğinin ne olduğu, neden var olduğu ve yaşam döngüsünü nasıl yönettiği konusunu daha önce [Sistem Mühendisliği Nedir?]({% post_url 2026-05-26-sistem-muhendisligi-nedir %}) yazısında ele almıştım. Bu yazı onun devamı niteliğinde: disiplinin kendisinden çok, o disiplindeki yetkinliğin nasıl belgelendiğine odaklanıyor.
...
<div class="mermaid">
flowchart LR
    M[2025 başı - Hedef ve INCOSE üyeliği] --> A[Temmuz 2025 - Hazırlık başlangıcı]
    A --> B[10 Ocak 2026 - Bilgi sınavı]
    B --> C[19 Temmuz 2026 - CSEP başvurusu]
    C --> D[12 Ağustos 2026 - Onay]
</div>
...
Sınav ile başvuru arasında geçen altı ay tamamen benim tercihimdi ve bu tercihin arkasındaki sebebe aşağıda döneceğim. Başvurunun değerlendirilmesi ise beklediğimden hızlı, yaklaşık **üç buçuk hafta** sürdü.
...
Pratik ayrıntılar, sınav sabahı sürpriz yaşamamak için önemli:
...
- **Ulaşımı önceden planlayın.** Sınav ODTÜ Teknokent'teki SSB Akademi binasında yapıldığı için, Teknokent araç kartı olmayanların plaka bilgilerini önceden organizasyona bildirip nizamiye kaydını yaptırması gerekiyor; aksi hâlde araçla giriş mümkün olmuyor. Bu tür yerleşke kuralları, davet e-postasında yazan ve gerçekten uyulması gereken maddeler.
...
Toplam hazırlık sürem **altı ay** oldu. Yoğun bir tempoyla değil, haftada birkaç akşam ve hafta sonlarının bir kısmıyla ilerleyen, düzenli ama sakin bir dönemdi. Kullandığım üç kaynak vardı.
...
Handbook'un **Türkçe çevirisi dördüncü baskıya ait** ve Savunma Sanayii Akademi Yayınları tarafından *Sistem Mühendisliği El Kitabı — Sistem Ömür Devri Yönetimi ve Faaliyetleri için Kılavuz* adıyla yayımlanmış durumda. Ben onu da bir kez okudum. Bunun bana somut bir faydası oldu: kavramların Türkçe karşılıklarını görmek, günlük işte kullandığım terimlerle Handbook'un terminolojisi arasındaki köprüyü kurmamı sağladı. Aviyonik dünyasında "verification" ve "validation" gibi terimleri zaten İngilizce kullanıyoruz; ancak "enabling system", "system of interest" veya "measures of effectiveness" gibi kavramların Türkçesini bir kez okumak, kavramın kendisini gerçekten anlayıp anlamadığımı test etmenin iyi bir yoluydu.

Ancak burada net bir uyarı gerekiyor: **Türkçe çeviri bir sınav kaynağı değildir.** İki sebeple. Birincisi, sınav artık beşinci baskıdan soruluyor ve iki baskı arasında yapısal farklar var. İkincisi, sınav İngilizce ve şıklar sıklıkla Handbook'un tam ifadelerini kullanıyor; kavramı Türkçe bilmek, doğru İngilizce ifadeyi seçmenizi garanti etmiyor. Türkçe baskıyı destekleyici bir kaynak olarak görün, ana kaynak olarak değil.

### Soru çözmenin yeri

Üçüncü kaynağım Udemy üzerindeki pratik soru setleri oldu. Bu setlerin değeri bilgi öğretmelerinde değil, iki başka şeyde:

- **Soru formatını tanımak.** INCOSE soruları çoğu zaman "hangisi *en iyi* tanımlar" veya "hangisi *değildir*" biçiminde kurulur. Şıkların üçü makul görünür, biri Handbook'un tam ifadesidir. Bu kalıba alışmak, sınavda ciddi zaman kazandırıyor.
- **Boşlukları tespit etmek.** Yanlış cevapladığım her soruyu Handbook'ta ilgili bölüme geri dönerek işaretledim. Hazırlığın son ayında çalıştığım şey kitabın tamamı değil, bu işaretli bölümlerdi.

Kullandığım setlerin bağlantıları yazının sonundaki [Kaynaklar](#kaynaklar) bölümünde. Şunu da eklemek isterim: piyasadaki pratik soruların hiçbiri gerçek sınav sorularının birebir yansıması değil. Bazıları Handbook'un eski baskısına dayanıyor, bazılarının cevap anahtarları tartışmalı. Doğru cevap oranınızı bir hedef olarak görmeyin; zayıf bölümlerinizi bulmak için bir araç olarak kullanın.
...
Başvuru formunda deneyim, önceden tanımlı **14 sistem mühendisliği alanına** dağıtılarak beyan ediliyor. Alanlar şunlar:
...
Benim gibi yazılım tarafından gelenler için asıl zihinsel egzersiz, yaptığı işi INCOSE'un diline çevirmek. DO-178C dünyasında yapılan işlerin karşılıkları büyük ölçüde mevcut:
...
| Kalem | Tutar |
|---|---|
| INCOSE üyeliği, 2 yıl — Regular PPP 2, 130 USD/yıl | 260 USD |
| Bilgi sınavı — Türkiye'deki kâğıt oturum | 1.000 TL |
| CSEP başvuru ücreti | 350 USD |
| **Toplam** | **610 USD + 1.000 TL** |

Buna üç yıl sonraki yenileme için 100 USD'lik ücret ve o dönem boyunca devam edecek üyelik aidatı da eklenecek.

Açık söyleyeyim: **başvuruyu tam da bu ücret yüzünden aylarca erteledim.** Sınavı ocak ayında geçmiştim ama başvuruyu ancak temmuzda gönderdim. Ertelemeye son veren şey şu oldu: sınav sonucunun geçerlilik süresi çoğu durumda **on iki ay**. Bu süre içinde başvurmazsanız sınava yeniden girmeniz gerekiyor. Pratik sonucu net: **sınava, başvuru ücretini ödemeye hazır olduğunuzda girin.**

---

## Sertifika Sonrası: Yenileme

CSEP üç yıl geçerli. Yenilemek için üç şey gerekiyor:
...
Soldaki çöküş, 2013–2019 arasında Türkiye'de kimsenin sertifika almadığı anlamına gelmiyor; o yıllarda sertifika alanların çoğunun bugün geçerli bir sertifikası olmadığı anlamına geliyor. İki olguyu birbirinden ayıramıyoruz.
...
Aşınma sorunu geriye dönük seriyi bozuyor ama ileriye dönük olana dokunmuyor: mevcut 135 süreli sertifikanın (6 ESEP kaydının bitiş tarihi yok) ne zaman yenilenmesi gerektiğini tam olarak biliyoruz.
...
2029 sonuna kadar 127 sertifikanın — mevcut süreli kayıtların %94'ü — yenilenmesi gerekiyor. Bu, Türkiye'deki topluluğun ilk kez bu ölçekte bir yenileme dalgasıyla karşılaşması demek — ve bugünkü 141 sayısının önümüzdeki yıllarda ne olacağını da esas olarak bu belirleyecek. Kaç kişinin PDU'sunu toplayıp yenilediğini ancak birkaç yıl sonra göreceğiz; bu yazının rakamları da o zaman geriye dönük olarak yeniden yorumlanmak zorunda kalacak.
...
ASEP'in zamanlaması dikkat çekici: dizindeki en eski ASEP kaydı 2023 tarihli, öncesinde tek bir tane bile yok. Burada da ihtiyatlı olmak gerekiyor, çünkü ASEP beş yıl geçerli — 2020'de ASEP almış ve 2025'te yenilememiş biri listede görünmezdi. Ama 2022'de alınmış bir ASEP 2027'ye kadar geçerli olurdu ve öyle bir kayıt da yok. Yani ASEP'in Türkiye'de gerçekten yeni yaygınlaştığı yönünde makul, ama tek başına kesin olmayan bir işaret var. Deneyimi CSEP'in 60 ay şartını karşılamayanlar için aşağıdaki öneri listesinin ilk maddesinde anlattığım yol bu.
...
Süreci baştan yaşamış biri olarak, sırayla uygulanabilecek somut önerilerim şunlar:
...
CSEP sürecinin bana kazandırdığı en değerli şey unvan olmadı. Altı aylık hazırlık, on yıla yakın sürede parça parça öğrendiğim pratikleri tek bir çerçeveye oturttu ve bu çerçevenin ne kadarını gerçekten bildiğimi, ne kadarını sadece uyguladığımı gösterdi. Sınavdan hemen sonra sistem mühendisliği yüksek lisansına başlamamın sebebi de buydu.
