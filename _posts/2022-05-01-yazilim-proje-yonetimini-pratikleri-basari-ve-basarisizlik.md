---
title: 'Yazılım Proje Yönetimi Pratikleri: Başarı ve Başarısızlık'
...
* 50 tanesi planlanan zamandan sonra bütçeyi %35 aşarak sonuçlandı,
...
Başarılı projeler planlamayı iyi yapıyor, başarısız projelerde ise çoğunlukla planlama hataları var.
...
Başarılı projelerde planlama süreci araçlar yardımı ile otomatize edilmiş durumda. Piyasada 50'den fazla ticari proje planlama aracı var. Başarılı projeler en az bir tanesini kullanıyor.

## Başarılı ve Başarısız Proje Maliyet Tahmini
Büyük yazılım projelerinde maliyet tahmini elle yapılamayacak kadar kompleks. Piyasadaki 75’ten fazla yazılım maliyet tahmini programının varlığı da bu durumu doğruluyor. Bunlardan en bilinenleri: COCOMO II, CostXpert, Knowledge-Plan, PRICE-S, SEER-SEM, SLIM

Başarılı projeler bu programlardan en az bir tanesini kullanıyor. Birden fazla programın kullanılması nadir değil. 
...
Projedeki verimlilik oranının abartılarak tahmin edilmesi ya da küçük bir proje ile büyük bir projedeki verimin aynı olacağı yanılgısı en sık yapılan hatalardan. 
...
Bazı devlet kurumları ve savunma sanayi hala eski Lines-of-code metrikini kullanıyor. Bu metrik kullanımı tehlikeli çünkü sadece yazılım aşamasını değerlendiriyor. Planlama, isterler, dokümantasyon, proje yönetimi, kalite güvencesi gibi alanları yok sayıyor. Satır sayısı ve proje arasındaki ilişki kullanılan dile bağlı. Çok büyük projelerde birden fazla yazılım dili kullanılıyor. 12 farklı yazılım dili içeren projeler mevcut.

Başarılı projelerde hataların yakalanma ve giderilme oranları da takip ediliyor. Başarılı projelerde hataların %95’i geliştirme aşamasında yakalanıyor. Bu sektör ortalaması %85’ten sadece 10 puan daha yüksek. 
...
Başarılı projelerin bir farkı da projede bir problem yaşandığında ya da takvimde bir gecikme görüldüğünde, düzeltici aksiyonları güçlü ve derhal bir şekilde yerine getirmesidir. Başarısız projelerde ise hatalar görmezden gelinip ötelenir. 

## Başarılı ve Başarısız Proje Değişiklik Yönetimi
10000 işlev puanına sahip projelerde analiz ve tasarım aşamasında her ay isterlerin %1 ile %3’ü arası değişiyor, ekleniyor veya siliniyor. Bu durum proje başında ve sonunda işlev puanlarının hesaplanması ile bulundu. Proje başında 10000 işlev puan olan bir proje tasarım aşaması bittikten sonra 12000 işlev puana çıkabiliyor. Toplamda %20’lik bir proje büyümesi demek bu. Arada geçen sürenin 10 ay olduğu varsayılırsa her ay proje %2 oranında büyümüş olmalı. Projedeki bu büyümeye bağlı olarak planların ve tahminlerin güncellenmesi gerekiyor.
...
Gerçek dünyada isterleri dondurmak pek olası bir durum değil. Bu yüzden değişikliğe hazır olmalıyız. 
...
Hata önleme ve hata giderme faaliyetlerindeki değişim proje sonucundaki hata oranında ciddi bir fark yaratıyor. 

Başarılı bir projede ortalama her işlev puanı 4.0 hata içeriyor ve hata önleme faaliyetlerinde %95’i müşteriye teslim edilmeden yakalanıyor. Bir başka deyişle, teslim edilen yazılımda her işlev puanına karşılık 0.2 hata var ya da toplamda 2000 hata var diyebiliriz. Bunların sadece %10’u (200 hata) kritik seviyede oluyor.

Başarısız bir projede ortalama her işlev puanı 7.0 hata içeriyor ve hata önleme faaliyetlerinde sadece %80’i müşteriye teslim edilmeden yakalanıyor. Bir başka deyişle, teslim edilen yazılımda her işlev puanına karşılık 1.4 hata var ya da toplamda 14000 hata var diyebiliriz. Bunların sadece %20’si (2800 hata) kritik seviyede oluyor.

Yukarıdaki 2 örnekten görülebileceği üzere 2 proje arasında kritik hatalarda 14 kat fark var. Bu farkı oluşturan asıl neden başarılı projelerde resmi tasarım ve kod denetimi aşamalarının hata yakalamada %65 verimli olması.

Başarısız projelerde genelde tasarım ve kodlama denetimi aşamaları pas geçilip hata bulmada sadece test aşamasına güveniliyor. **Bu durum aşağıdaki 3 probleme neden oluyor:**
...
## Sonuç
Büyük yazılım sistemlerinin başarısızlıkla sonuçlanmasının birçok yolu vardır. Projeyi başarılı sonuçlandırmanın ise sadece birkaç yolu var. Proje yönetiminin, projeleri başarıya veya başarısızlığa götüren ana faktör olması ilginçtir.
