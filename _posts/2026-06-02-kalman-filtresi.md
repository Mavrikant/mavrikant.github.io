...
3. **Iraksamaya (divergence) karşı uyanık olun.** En sinsi hata, `P`'nin gerçek hatadan çok daha küçük olması — filtre kendine güvenir, gelen ölçümleri "aykırı" sanıp reddeder, gerçeğden gitgide kopar. Sebepleri: çok küçük `Q`, modellenmemiş bir dinamik, ya da sayısal yuvarlama. Lineer simülatörde `q`'yu dibe çekerek bunu birebir görebilirsiniz.
